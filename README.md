...
A full reference for this library is available [here](https://github.com/lealhq/leal-go-sdk/blob/HEAD/./reference.md).
...
```go
client := client.NewClient(
    option.WithBaseURL(leal.Environments.Production),
)
```
