...
func TestLocationsListWithWireMock(
	...
	VerifyRequestCount(t, "TestLocationsListWithWireMock", "GET", "/api/v1/accounts/1/locations", nil, 1)
}
...
func TestLocationsCreateWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestLocationsCreateWithWireMock", "POST", "/api/v1/accounts/1/locations", nil, 1)
}
...
func TestLocationsGetWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestLocationsGetWithWireMock", "GET", "/api/v1/accounts/1/locations/1", nil, 1)
}

func TestLocationsDeleteWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	invocationErr := client.Locations.Delete(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestLocationsDeleteWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestLocationsDeleteWithWireMock", "DELETE", "/api/v1/accounts/1/locations/1", nil, 1)
}
...
func TestLocationsUpdateWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestLocationsUpdateWithWireMock", "PATCH", "/api/v1/accounts/1/locations/1", nil, 1)
}
